import { Controller, Res, Get, Post, Body, Patch, Param, Delete, ValidationPipe } from '@nestjs/common';
import { Response } from 'express';
import { UsersService } from './users.service';
import { CreateUserDto, GetUserByIds, GetUserDto, UpdateUserDto } from './dto/create-user.dto';
...
export class UsersController {
  ...
  @Get(':userid')
  findOne(@Param(new ValidationPipe()) params: GetUserDto, @Res() res: Response) {
  ...
  @Delete('/delete/:id')
  deleteUser(@Param(new ValidationPipe()) params: GetUserDto, @Res() res: Response) {
